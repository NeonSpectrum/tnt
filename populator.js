module.exports = function(db) {
  return {
    populateQuestionnaire: function() {
       ...
       * Questionnaire
       */
      db.collection('questionnaire').insertOne(
        {
          difficulty: 'kayangkaya',
          category: 'Current Events',
          question:
            'What is the middle name of the newly elected President of the Republic of the Philippines?',
          choice_a: 'Fernandez',
          choice_b: 'Reyes',
          choice_c: 'Roa',
          choice_d: 'Rodney',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the venue where the Philippine Government panel and CPP-NPA NDF consultants are holding peace talks?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'In what capital city was the Pope greeted by 6 million people on his visit to it in January 2015?',
          choice_a: 'Manila',
          choice_b: 'Havana',
          choice_c: 'Paris',
          choice_d: 'Ankara',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Who is the new secretary of the Department of Finance under President Duterte’s administration?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Last June 30, 2016, President Duterte took his oath in Malacañang before a Supreme Court Associate Justice. What is the name of this Justice?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Last July 4, President Barack Obama celebrated his daughter Malia’s birthday which also was America’s Independence Day. What is his daughter’s age  during the celebration?',
          choice_a: '17',
          choice_b: '18',
          choice_c: '19',
          choice_d: '20',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the mode for charter change with which President Duterte prefers to amend the Philippine Constitution?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the name of the hospital where Sen. Miriam Defensor-Santiago was rushed last May 30, 2016, due to complication of her late-stage lung cancer?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Who is the running mate of Donald Trump in the upcoming November national election of the United States of America?',
          choice_a: 'Mike Pence',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'How much is the expected peso increase in the pension of retired Social Security System (SSS) members that President Duterte granted to pensioners?',
          choice_a: '₱2,000.00',
          choice_b: '₱2,400.00',
          choice_c: '₱3,200.00',
          choice_d: '₱1,200.00',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the type of government which believes that power and authority is allocated between the national and local government units?',
          choice_a: 'Federalism',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the sports event in which Scott Mitchell beat Martin Adams for the World Championship in January 2015?',
          choice_a: 'Chess',
          choice_b: 'Archery',
          choice_c: 'Darts',
          choice_d: 'Billiards',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Who is the Representative who refiled the SSS pension hike bill in the 17th Congress last July 25, 2016?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'For the Department of Agriculture, what is the target yield of rice in Central Luzon to make the crop sufficient under the Duterte administration?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the force battalion that took over the New Bilibid Prison in Muntinlupa last July 20, 2016, to crack down on drug lords?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the term used by the PNP pertaining to their police operation plans to address rampant criminality in the National Capital Region and eventually over the whole country through data-driven strategies?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the name of the foundation where U.S. Republican presidential candidate Donald Trump donated a $1 million check dated May 24, 2016, from his personal account and is considered as his largest donation among the veterans’ charities in America?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the Supreme Court Justices’ vote count to dismiss the PCSO plunder case against former President Gloria Arroyo?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'Who is Brazil’s new acting President, and who was inaugurated on June 1, 2016 because the prior President was suspended to face an impeachment trial?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Current Events',
          question:
            'What is the title of Brillante Mendoza’s film that won the Le Prix Chandrika Charma at the 8th International Film Festival of the Fisherman of the World in Lorient, France?',
          choice_a: '"Hamog"',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          question:
            'The Filipino scientist who built the first radioisotope laboratory in the Philippines is',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'In the geological sense, the safest place to live in the Philippines because it is the farthest from volcanoes and earthquakes is',
          choice_a: 'Davao City',
          choice_b: 'Palawan',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'The 8 rays of the sun in the Philippine flag represent the first 8 provinces which started the 1896 revolution. Which of the following is not a member of the first 8 provinces',
          choice_a: 'Ilocos',
          choice_b: 'Laguna',
          choice_c: 'Batangas',
          choice_d: 'Pampanga',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'The Philippine area, which is about 300,000 square kilometers corresponds approximately to the area of',
          choice_a: 'Indonesia',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'Eugenio Torre, the first International Grandmaster, won the Chess Olympiad in 1974 held in',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'The Philippine mouse-deer, the smallest hoofed animal, is found in Balabac Island. It is locally known as',
          choice_a: 'Napu',
          choice_b: 'Chevrotain',
          choice_c: 'Pilandok',
          choice_d: 'Lawanit',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'The first person in the world with an antenna implanted in his skull and recognized as the world’s first cyborg artist is',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'An organism that has restored function or enhanced abilities due to the integration of some artificial component or technology that relies on some sort of feedback is termed as',
          choice_a: 'Bionic',
          choice_b: 'Biorobot',
          choice_c: 'Android',
          choice_d: 'Cyborg',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'General Information',
          question:
            'The Filipino biologist who invented the artificial coral reefs used for fisheries in Southeast Asia is',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          question:
            'A piece of stone weighs 22.7 g. When it is submerged in a graduated cylinder containing 50.0 mL of water, the level rose to 60.0 mL. What is the density of the stone in g/mL?',
          choice_a: '0.206',
          choice_b: '0.227',
          choice_c: '2.060',
          choice_d: '2.270',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'The nucleic acid present in virus is either DNA or RNA. Which of the following is not an RNA virus?',
          choice_a: 'Measles',
          choice_b: 'Ebola',
          choice_c: 'Small Pox',
          choice_d: 'Mumps',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'A female triathlon participant swims across the Cagayan River flowing south at a rate of 0.5 m/s. The participant keeps swimming perpendicular to the river at a rate of 0.5 m/s heading east. What is the resultant velocity of the female triathlon participant?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'A car that travels 40 km/h for 2 h, at 50 km/h for 1 hr, and 20 km/h for 0.5 h, has an average speed of _____.',
          choice_a: '25 km/hr',
          choice_b: '37 km/hr',
          choice_c: '40 km/hr',
          choice_d: '45 km/hr',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'In a snail race, five contestants measured the distance covered by their pet snails after a minute; Rev at 19 centimeters, York at 700 millimeters, Ellie at 340 micrometers and Sybil at 6,700 nanometers. Which best represents the distance travelled by each snail in increasing order?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'Mark Zuckerberg is an American computer programmer and Internet entrepreneur. He is best known as one of five co-founders of a social networking website. What is the real name of Mark Zuckerberg?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'Individuals who take a sedative-hypnotic to get to sleep at night sometimes complain of drowsiness and reduced motor performance the next day. This effect is known as the',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'After injection of local anesthetics, loss of function results in which of the following possible orders?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'During fasting, in what sequence are the following organic compounds used up by the body?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'Prolactin is a hormone that activates milk production in mothers. Which gland produces this hormone?',
          choice_a: 'Pineal',
          choice_b: 'Thyroid',
          choice_c: 'Pituitary',
          choice_d: 'Pancreas',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'What do you call the phenomenon wherein materials like zinc oxide wires release electricity when they are bent and afterwards relaxed?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'What do you call acids that will produce one mole of hydrogen ions when one mole of the acid dissolves in water?',
          choice_a: 'monoacidic',
          choice_b: 'monoprotic',
          choice_c: 'monatomic',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Science and Technology',
          question:
            'What do you call the thin outermost layer of the Earth which is made up of soil subject to soil formation processes?',
          choice_a: 'Litosphere',
          choice_b: 'Pedosphere',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'Given A = { m, a, t, h }, B = { a, l, g, e, b, r, a }, C = { x/x is a vowel in the word "Benedict" that appears more than once }. Find ( A ∪ B ) ∩ C',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'If 1 is subtracted from eight times a certain number the result is the same as if 89 is added to three times the number. Find the number.',
          choice_a: '18',
          choice_b: '20',
          choice_c: '24',
          choice_d: '30',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'The sum of the digits of a two-digit number is 8. If the digits are reversed, the new number is 18 more than the original number. What is the original number?',
          choice_a: '17',
          choice_b: '26',
          choice_c: '35',
          choice_d: '53',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'Jun wants to have an average grade of at least 88 in his Mathematics class. If he got 86, 90 and 87 in the first three quarters, what grade must he get in the last quarter?',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            "Jan, Jen and Jin prepared a party for their grandmother and had their shares in the ratio 3:2:5. If they spent Php 15,000 for the party, how much was Jen's contribution?",
          choice_a: 'Php 3,000',
          choice_b: 'Php 4,500',
          choice_c: 'Php 5,000',
          choice_d: 'Php 7,500',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'At the last party Abby prepared 18 meatballs from 2.5 lbs of hamburger. Abby is planning another party and needs 54 meatballs. How many pounds of hamburger does she need?',
          choice_a: '6 pounds',
          choice_b: '6.5 pounds',
          choice_c: '7 pounds',
          choice_d: '7.5 pounds',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'The measure of a complement of an angle is 5 times the measure of the angle. What is the measure of the angle?',
          choice_a: '15',
          choice_b: '45',
          choice_c: '60',
          choice_d: '75',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'A piece of wire is shaped to enclose an equilateral triangle in which the area is 16<sup>√3</sup> cm<sup>2</sup>. It is then reshaped to enclose a rectangle whose length is 9 cm. Find the area of the rectangle.',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'How many square inches of a material are needed to create an open top rectangular solid, the volume of which is 54 cubic inches? Assume that the length and width are of the same measurements and that the height is twice the length.',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'How many months should Sally invest Php 600,000.00 to earn Php 108,000.00 at the rate of 12% annually?',
          choice_a: '6 mos.',
          choice_b: '12 mos.',
          choice_c: '18 mos.',
          choice_d: '24 mos.',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'Find the remainder when (5W<sup>3</sup> - 2W<sup>2</sup> + 5W - 14) is divided by (W - 2)?',
          choice_a: '2',
          choice_b: '5',
          choice_c: '14',
          choice_d: '28',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'What is the radius of the largest circle that can be inscribed in a square whose area is 576 square units?',
          choice_a: '10 units',
          choice_b: '12 units',
          choice_c: '14 units',
          choice_d: '16 units',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            "Paul received from his parents the following amount for his daily expenses in school: Monday, P225; Tuesday, P250; Wednesday, P230; Thursday, P210. How much did Paul receive on Friday to average P240 as Paul's daily allowance for the week?",
          choice_a: '₱285',
          choice_b: '₱280',
          choice_c: '₱275',
          choice_d: '₱270',
      ...
      db.collection('questionnaire').insertOne(
        {
          ...
          category: 'Mathematics',
          question:
            'A woman has a 180mile-trip to make, of which the 1st third is over congested highways while the remainder is over a good freeway. If she averages 40miles/hr over the 1st 60miles, at what average speed in miles/hr must she drive the remaining 120miles to average 45miles/hr for the entire trip?',
